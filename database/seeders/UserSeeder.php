...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $shippingMember1->organizations()->attach($shippingOrg1, ['role' => UserRoles::MANAGER->value]);
        ...
        $vesselMember1->organizations()->attach($vesselOrg1, ['role' => UserRoles::MANAGER->value]);
