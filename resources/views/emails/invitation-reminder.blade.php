...
<body>
    <div class="container">
        <div class="header">
            <div class="logo">
                <svg width="150" height="44" viewBox="0 0 630 148" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="tagline">Streamlining Port Operations & Vessel Services</p>
        </div>
        ...
        <div class="content">
            ...
            <p style="margin-top: 24px; padding: 16px; border: 1px solid #D6A165; background-color: #f8f8f8;">
