...
export default function CreatePortPage() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Port" />

            <form onSubmit={submit} className="flex flex-col gap-8 p-8">
                <div className="flex flex-col gap-1">
                    <h1 className="text-xl font-semibold">Create Port</h1>
                    <p className="text-base text-muted-foreground">
                        Fill out the form below to create a new port. You can specify the port name, code, location, and status.
                    </p>
                </div>
