                                        ...
                                        <div key={service.id} className="flex items-start justify-between rounded-lg border p-4">
                                            <div className="flex-1">
                                                <div className="mb-2 flex items-center gap-2">
                                                    <h4 className="font-medium">{service.sub_category?.name || 'Service'} - {service.organization?.name || 'Unknown Provider'}</h4>
                        ...
                        {safeServices.map((service, index) => (
                            <div key={service.id} className="flex items-center justify-between border-b py-3 last:border-b-0">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="font-medium">{service.sub_category?.name || 'Service'} - {service.organization?.name || 'Unknown Provider'}</div>
