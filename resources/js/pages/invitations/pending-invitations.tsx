            ...
            <>
                ...
                <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
                    <Card className="w-full max-w-md text-center">
                        ...
                        <CardContent>
                            <Button onClick={() => router.get(route('dashboard'))}>Go to Dashboard</Button>
                        </CardContent>
                    </Card>
                </div>
            </>
                                ...
                                <Card key={invitation.id} className="w-full">
                                    <CardHeader>
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <CardDescription>Invitation to join as {invitation.role_label}</CardDescription>
                                            </div>
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="flex flex-col gap-2 sm:flex-row">
                                            <Button onClick={() => handleAccept(invitation.token)} disabled={isProcessing} className="flex-1">
