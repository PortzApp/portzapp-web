...
import { Plus, Ship, Package, Clock, ArrowRight, BarChart3 } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 flex-1">
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <span className="font-medium group-hover:underline transition-all">Manage Vessels</span>
                                </div>
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <span className="font-medium group-hover:underline transition-all">View All Orders</span>
                                </div>
                                <ArrowRight className="h-4 w-4" />
                            </Button>
                            <Button 
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <span className="font-medium group-hover:underline transition-all">Pending Orders</span>
                                </div>
                                <ArrowRight className="h-4 w-4" />
                            </Button>
                            <Button 
                            ...
                            >
                                <div className="flex items-center">
                                    ...
                                    <span className="font-medium group-hover:underline transition-all">Place New Order</span>
                                </div>
                                <ArrowRight className="h-4 w-4" />
                            </Button>
                        </div>
            ...
            <RecentOrdersTable
                ...
                description="Latest orders you've placed"
            />
        </div>
    );
}